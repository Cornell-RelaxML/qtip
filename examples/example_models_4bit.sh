...
python -m quantize_llama.quantize_finetune_llama \
       --save_path $CKPT/2_13b_chat_4bit \
       --codebook bitshift \
       ...
       --decode_mode quantlut_sym \
       --tlut_bits 9 \
       >> $LOG/2_13b_chat_4bit 2>&1

python -m quantize_llama.quantize_finetune_llama \
       --save_path $CKPT/2_70b_4bit \
       --codebook bitshift \
...
python -m quantize_llama.quantize_finetune_llama \
       --save_path $CKPT/2_70b_chat_4bit \
       --codebook bitshift \
       ...
       --decode_mode quantlut_sym \
       --tlut_bits 9 \
       >> $LOG/2_70b_chat_4bit 2>&1


CUDA_VISIBLE_DEVICES=0 python -m quantize_llama.hfize_llama --quantized_path $CKPT/2_7b_4bit --hf_output_path $HF/2_7b_4bit >> $LOG/2_7b_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=1 python -m quantize_llama.hfize_llama --quantized_path $CKPT/2_7b_chat_4bit --hf_output_path $HF/2_7b_chat_4bit >> $LOG/2_7b_chat_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=2 python -m quantize_llama.hfize_llama --quantized_path $CKPT/2_13b_4bit --hf_output_path $HF/2_13b_4bit >> $LOG/2_13b_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=3 python -m quantize_llama.hfize_llama --quantized_path $CKPT/2_13b_chat_4bit --hf_output_path $HF/2_13b_chat_4bit >> $LOG/2_13b_chat_4bit 2>&1 & 
CUDA_VISIBLE_DEVICES=4 python -m quantize_llama.hfize_llama --quantized_path $CKPT/2_70b_4bit --hf_output_path $HF/2_70b_4bit >> $LOG/2_70b_4bit 2>&1 &
...
CUDA_VISIBLE_DEVICES=2 python -m eval.eval_ppl  --hf_path $HF/2_13b_4bit >> $LOG/2_13b_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=3 python -m eval.eval_ppl  --hf_path $HF/2_13b_chat_4bit >> $LOG/2_13b_chat_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=4 python -m eval.eval_ppl  --hf_path $HF/2_70b_4bit >> $LOG/2_70b_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=5 python -m eval.eval_ppl  --hf_path $HF/2_70b_chat_4bit >> $LOG/2_70b_chat_4bit 2>&1 &

wait

CUDA_VISIBLE_DEVICES=0 python -m eval.eval_zeroshot --tasks arc_challenge,arc_easy,boolq,piqa,winogrande --batch_size 16  --hf_path $HF/2_7b_4bit >> $LOG/2_7b_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=1 python -m eval.eval_zeroshot --tasks arc_challenge,arc_easy,boolq,piqa,winogrande --batch_size 16  --hf_path $HF/2_7b_chat_4bit >> $LOG/2_7b_chat_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=2 python -m eval.eval_zeroshot --tasks arc_challenge,arc_easy,boolq,piqa,winogrande --batch_size 16  --hf_path $HF/2_13b_4bit >> $LOG/2_13b_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=3 python -m eval.eval_zeroshot --tasks arc_challenge,arc_easy,boolq,piqa,winogrande --batch_size 16  --hf_path $HF/2_13b_chat_4bit >> $LOG/2_13b_chat_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=4 python -m eval.eval_zeroshot --tasks arc_challenge,arc_easy,boolq,piqa,winogrande --batch_size 16  --hf_path $HF/2_70b_4bit >> $LOG/2_70b_4bit 2>&1 &
CUDA_VISIBLE_DEVICES=5 python -m eval.eval_zeroshot --tasks arc_challenge,arc_easy,boolq,piqa,winogrande --batch_size 16  --hf_path $HF/2_70b_chat_4bit >> $LOG/2_70b_chat_4bit 2>&1 &
