...
class StaticCache(Cache):
    ...
    def update(
        ...
        if cache_position is None:
            ...
            try:
                k_out.index_copy_(2, cache_position.to(k_out.device), key_states.to(k_out.device))
                v_out.index_copy_(2, cache_position.to(v_out.device), value_states.to(v_out.device))
